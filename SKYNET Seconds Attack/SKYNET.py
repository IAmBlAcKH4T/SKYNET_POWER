...
class DDoS:
    ...
    flag = 0
    kill = 0
    attack_duration = 1  # Set attack_duration to 1 hour
    pause_duration = 1  # Set pause duration to 1 hour
    response_delay = 1  # Set response_delay to 1 hour
    lock_object = ddos.Lock()
    message_printed = True
    attack_start_time = time.time()
    attack_end_time = attack_start_time + 1  # Set attack_end_time to 1 hour after attack_start_time
    ...
    def http_call(cls, url):
        ...
        try:
            ...
            while (time.time() - start_time) < desired_sleep_hours:
                time.sleep(1)  # Sleep for 1 second
            hour_timeout = 1  # 1 hour in seconds
    ...
    def http_thread(cls):
        try:
            ...
            end_time = start_time + 1  # Set the end time to 1 second from the start time
